...
- [🚀 `docs/DEPLOYMENT_GUIDE.md`](DEPLOYMENT_GUIDE.md) — руководство, строго по которому выполнялась валидация.
- [📊 `docs/PROJECT_STATE.md`](PROJECT_STATE.md) — паспорт текущего статуса проекта.
- [📄 `docs/SPEC.md`](SPEC.md) — критерии приёмки, лежащие в основе чек-листа валидации.
---

**Статус:** PASS — пере-валидация v1.5 в чистом окружении (18/18); валидация v1.0 — 2026-08-13
