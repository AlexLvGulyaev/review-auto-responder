...
| 2026-09-03 | Обязательный технический долг закрыт (фиксация) | Решение владельца 03.09: обязательный технический долг проекта закрыт; оставшиеся пункты обязательным долгом не являются и ведутся как SHOULD/COULD-роадмап — «Возможное развитие»: batch execution tracing (актуально только при высоких объёмах) |
